UNIX BUILD NOTES
====================
Some notes on how to build fractalcoin in Unix. 
...
This will build fractalcoin-qt as well if the dependencies are met.
...
If you want to build fractalcoin-Qt, make sure that the required packages for Qt development
...
Once these are installed, they will be found by configure and a fractalcoin-qt executable will be
built by default.

Notes
-----
The release is built with GCC and then "strip fractalcoind" to strip the debug
