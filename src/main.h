...
static const int COINBASE_MATURITY = 10; //CHANGE BEFORE RELEASE //60*6; // about 6 hours before blocks mature, so if something goes wrong pools can coordinate before payouts
