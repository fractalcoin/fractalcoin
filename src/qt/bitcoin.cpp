...
/** Class encapsulating Fractalcoin Core startup and shutdown.
...
/** Main Fractalcoin application object */
...
*/
        ...
        // fractalcoin: URIs or payment requests:
        /*
...
{
    QMessageBox::critical(0, "Runaway exception", BitcoinGUI::tr("A fatal error occurred. Fractalcoin Core can no longer continue safely and will quit.") + QString("\n\n") + message);
    ::exit(1);
}
...
int main(int argc, char *argv[])
{
    ...
    {
        QMessageBox::critical(0, QObject::tr("Fractalcoin Core"),
    ...
    if (!SelectParamsFromCommandLine()) {
        QMessageBox::critical(0, QObject::tr("Fractalcoin Core"), QObject::tr("Error: Invalid combination of -regtest and -testnet."));
        return 1;
    }
#ifdef ENABLE_WALLET
    ...
    // fractalcoin: links repeatedly have their payment requests routed to this process:
